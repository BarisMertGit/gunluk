...
export default function MainFeed() {
  ...
  return (
    <div className="px-4 py-6 pb-6">
              ...
              return (
                <div
                  ...
                  className={`flex flex-col items-center justify-center rounded-2xl py-1 ${
                    entryForDay
                      ? "bg-gradient-to-br bg-slate-100"
                      : "bg-gray-50"
                ...
                >
                  ...
                  <span
                    className={`text-sm font-semibold ${
                      isToday ? "text-slate-700" : "text-gray-900"
                    }`}
                  >
                    {format(day, "d")}
                  </span>
        ...
        {entries.length === 0 ? (
          <div className="text-center py-24 px-4">
            ...
            <Link to={createPageUrl("NewEntry")}>
              <Button className="bg-gradient-to-r bg-slate-700 hover:bg-slate-800 px-8 py-6 text-base">
      ...
      <Link to={createPageUrl("NewEntry")}>
        <button 
          className="fixed bottom-20 right-6 w-14 h-14 rounded-full shadow-xl bg-gradient-to-r bg-slate-700 hover:bg-slate-800 hover:scale-105 transition-all z-40 flex items-center justify-center"
        >
